...
namespace personel_organizer_ilk
{
    public partial class SalaryCalculator : Form
    {
        public SalaryCalculator()
        {
            ...
            grpBoxEducation.BackColor = Color.Transparent;
            grpBoxFamily.BackColor = Color.Transparent;
            grpBoxLanguage.BackColor = Color.Transparent;
            grpBoxOther.BackColor = Color.Transparent;
            btnBack.BackColor = Color.Transparent;
            lblBack.BackColor = Color.Transparent;
        }
        public string path = "Kullanıcılar.csv";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Login.userList[i].Username == user.Username)
                    Login.userList[i].Salary = txtBoxSalary.Text;
            }
            LoginedUser.getInstance().UserGetSet.Salary = txtBoxSalary.Text;
            Util.SaveCsv(Login.userList, path);
        }
